...
export const recruitmentActions: readonly RecruitmentAction[] = [
  ...
  // TODO: Add a complete verified email address before enabling this action.
  {
    id: "captain-exec-email",
    kind: "email",
    label: "Whisper captains and executive board",
    description: "The supplied alias is gr-ateam_exec, but its full email address still requires confirmation.",
    enabled: false,
    public: false,
    external: false,
  },
